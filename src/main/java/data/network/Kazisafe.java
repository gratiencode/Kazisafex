...
public interface Kazisafe {
    ...
    Call<User> singUp(
        ...
        @Part("nom") RequestBody var4,
        @Part("prenom") RequestBody var5,
        @Part("phone") RequestBody var6,
    ...
    Call<Entreprise> createEntreprise(
        @Part okhttp3.MultipartBody.Part var1,
    ...
    Call<ResponseBody> notifySubscribed(
        @Path("uid") String path,
    ...
    Call<ResponseBody> verifySync(
        @Path("table") String var1,
        @Path("entrep") String ese
    );

    @POST("subscription/save/point")
    Call<SubscriptionPayment> getAbonnementPayment(
        @Body SubscriptionPayment var1
    );

    @GET("repport/{rccm}/{date1}/{date2}")
    Call<VueAbonnement> showAbonnement(
        @Path("rccm") String var1,
        @Path("date1") String var2,
        @Path("date2") String var3
    );

    @GET("v1/finance/immobilisations")
    Call<List<Immobilisation>> getImmobilisations(
        @Query("region") String region
    );

    @POST("v1/finance/immobilisations")
    Call<Immobilisation> createImmobilisation(
        @Body Immobilisation immobilisation
    );

    @PATCH("v1/finance/immobilisations/{uid}")
    Call<Immobilisation> updateImmobilisation(
        @Path("uid") String uid,
        @Body Immobilisation immobilisation
    );
    ...
    Call<WebResult> syncImmobilisations(
        @Body List<Immobilisation> immobilisations
    );

    @GET("immobilisations/downsync")
    Call<List<Immobilisation>> syncMissedImmobilisations(
        @Query("lt") String since
    );
    ...
    Call<List<Presence>> getPresences(
    ...
    Call<CompteResultatReport> getCompteResultat(
        @Query("dateDebut") String dateDebut,
        @Query("dateFin") String dateFin,
        @Query("region") String region
    );
    ...
    @POST("auth/refresh")
    Call<TokenRefreshed> refreshTokenWithHeader(
    ...
    Call<List<Destocker>> getDestockers(
        @Path("date1") String var1,
        @Path("date2") String var2
    );
    ...
    Call<Destocker> getDestockageByRef(
        @Path("ref") String var1,
        @Path("prod") String prod8,
        @Path("entr") String entr
    );
    ...
    Call<Employee> affectAgent(
        @Query("id") String var1,
    ...
    Call<Fournisseur> updateForunisseur(
        @Body Fournisseur var1,
        @Path("uid") String var2
    );
    ...
    Call<List<Mesure>> syncDownMesures(
        @Body List<String> prodIds,
        @Path("entr") String entrep
    );

    @GET("mesures/show/all/for/produit/loc/{rccm}/{codebar}/{region}")
    Call<List<Mesure>> getMesureForProductInRegion(
        @Path("rccm") String var1,
        @Path("region") String var2,
    ...
    Call<Void> notifyEvent(
        @Query("id") String var1,
        @Query("sender") String var2,
        @Query("receiver") String var3,
        @Query("region") String var4,
        @Query("contenu") String var5,
        @Query("facture") String var6
    );

    @GET("charges/show/all/for/region/{region}/period/{date1}/{date2}")
    Call<List<Operation>> getExpenseForRegionInPeriod(
        @Path("region") String var1,
        @Path("date1") String var2,
        @Path("date2") String var3
    );

    @GET("charges/show/all/regs/for/period/{date1}/{date2}")
    Call<List<Operation>> getExpensesForAllInPeriod(
        @Path("date1") String var1,
        @Path("date2") String var2
    );
    ...
    Call<List<Operation>> getSumExpenseForRegionInPeriod(
        @Path("region") String var1,
        @Path("date1") String var2,
        @Path("date2") String var3
    );
    ...
    Call<List<Operation>> getSumExpensesForAllInPeriod(
        @Path("date1") String var1,
        @Path("date2") String var2
    );
    ...
    Call<Operation> updateOperation(
        @Path("uid") String var1,
        @Body Operation var2
    );
    ...
    Call<PrixDeVente> getPrixDeventeForProduct(
        @Path("codebar") String var1,
        @Path("mesure_name") String var2,
    ...
    Call<List<PrixDeVente>> syncPricesDown(
        @Body List<String> reqIds,
        @Path("entr") String entr
    );
    ...
    Call<PrixDeVente> updatePrixDeVente(
        @Path("uid") String var1,
        @Body PrixDeVente var2
    );
    ...
    @POST("req/show/all")
    Call<List<Recquisition>> showAllRecquisitionForMyCompany(
        @Body Entreprise entr
    );
    ...
    Call<String> updatePricesWithPercentForRegion(
        @Path("region") String var1,
        @Path("percent") String var2
    );
    ...
    Call<Recquisition> updateRecquisition(
        @Path("uid") String var1,
        @Body Recquisition var2
    );
    ...
    @FormUrlEncoded
    @PATCH("req/x-sync")
    Call<Recquisition> syncRecquisition(
        @Field("uid") String uid,
    ...
    Call<List<VuStock>> showInventaireStrockAllProduit(
        @Path("date1") String var1,
        @Path("date2") String var2
    );
    ...
    Call<List<VuStock>> showMouvementStockProduit(
        @Path("produit") String var1,
        @Path("date1") String var2,
        @Path("date2") String var3
    );
    ...
    Call<Traisorerie> updateTraisorerie(
        @Path("uid") String var1,
        @Body Traisorerie var2
    );
    ...
    Call<List<Traisorerie>> showTresorParTypeParRegion(
        @Path("region") String var1,
        @Path("date1") String var2,
        @Path("date2") String var3
    );
    ...
    Call<List<Traisorerie>> showEntreeParTypeParRegion(
        @Path("region") String var1,
        @Path("date1") String var2,
        @Path("date2") String var3
    );
    ...
    Call<List<Traisorerie>> showSortieParTypeParRegion(
        @Path("region") String var1,
        @Path("date1") String var2,
        @Path("date2") String var3
    );
    ...
    Call<NetCash> showTreasuryStatus(
        @Path("region") String var1,
        @Path("type") String var2
    );

    @GET("traisorerie/show/enks/all/{date1}/{date2}")
    Call<List<Traisorerie>> allEntreeCaisse(
        @Path("date1") String var1,
        @Path("date2") String var2
    );

    @GET("traisorerie/showVente/dks/all/{date1}/{date2}")
    Call<List<Traisorerie>> allSortieCaisse(
        @Path("date1") String var1,
        @Path("date2") String var2
    );
    ...
    Call<String> confirmByMail(
        @Path("email") String var1,
        @Path("code") String var2,
        @Path("lang") String lang
    );

    @GET("user/validate/by/sms/{phone}/{code}/{lang}")
    Call<String> validateBySms(
        @Path("phone") String var1,
        @Path("code") String var2,
        @Path("lang") String lang
    );

    @GET("ventes/sales/show/{date1}/{date2}")
    Call<List<Vente>> showVentes(
        @Path("date1") String var1,
        @Path("date2") String var2
    );
    ...
    Call<SoldeDetteClient> searchPayment(
        @Path("ref") String ref,
        @Path("ent") String ent
    );
    ...
    Call<Checked> checkDependancy(
        @Path("table") String table,
        @Path("uidelt") String uidelt
    );

    @GET("safesync/categories/{entr}/{first}")
    Call<List<Category>> syncDownCategories(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @GET("safesync/destocks/{entr}/{first}")
    Call<List<Destocker>> syncDownDestockers(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @GET("safesync/ligneventes/{entr}/{first}")
    Call<List<LigneVente>> syncDownLigneVentes(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @GET("safesync/livraisons/{entr}/{first}")
    Call<List<Livraison>> syncDownLivraisons(
        @Path("entr") String entr,
        @Path("first") String dcount
    );
    ...
    Call<List<Operation>> syncDownOperations(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @GET("safesync/prices/{entr}/{first}")
    Call<List<PrixDeVente>> syncDownPrices(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @GET("safesync/produits/{entr}/{first}")
    Call<List<Produit>> syncDownProducts(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @GET("safesync/recquisitions/{entr}/{first}")
    Call<List<Recquisition>> syncDownRecquisitions(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @GET("safesync/stocks/{entr}/{first}")
    Call<List<Stocker>> syncDownStockers(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @GET("safesync/taxers/{entr}/{first}")
    Call<List<Taxer>> syncDownTaxers(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @GET("safesync/traisories/{entr}/{first}")
    Call<List<Traisorerie>> syncDownTraisories(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @GET("safesync/sales/{entr}/{first}")
    Call<List<Vente>> syncDownVentes(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @GET("safesync/suppliers/{entr}/{first}")
    Call<List<Fournisseur>> syncDownSuppliers(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @GET("safesync/customers/{entr}/{first}")
    Call<List<Client>> syncDownCustomers(
        @Path("entr") String entr,
        @Path("first") String dcount
    );

    @PUT("tresor/{name}/save/point")
    public Call<CompteTresor> saveCompteTesor(
        @Path("name") String id,
        @Body CompteTresor ctr
    );
    ...
    @FormUrlEncoded
    @PATCH("tresor/x-sync")
    public Call<CompteTresor> saveCompteTresorByForm(
        @Field("uid") String uid,
    ...
    public Call<List<Permission>> loadAgentPermission(
        @Path("engId") String engagementId
    );

    @PATCH("perms")
    @FormUrlEncoded
    public Call<Affecter> createAffecter(
        @Field("uidPerm") String uidperm,
        @Field("role_name") String rolename,
        @Field("region") String region,
        @Field("emp") String empl
    );

    @GET("perms/change/{p}/{e}")
    public Call<String> changePermission(
        @Path("p") String permid,
        @Path("e") String empid
    );
    ...
    public Call<List<Category>> syncMissedCategories(
        @Query("lt") String timestamp
    );

    @GET("produit/downsync")
    public Call<List<Produit>> syncMissedProducts(
        @Query("lt") String timestamp
    );
    ...
    public Call<List<Fournisseur>> syncMissedSuppliers(
        @Query("lt") String timestamp
    );

    @GET("livraison/downsync")
    public Call<List<Livraison>> syncMissedDeliveries(
        @Query("lt") String timestamp
    );
    ...
    public Call<List<Destocker>> syncMissedDestokers(
        @Query("lt") String timestamp
    );

    @GET("req/downsync")
    public Call<List<Recquisition>> syncMissedRecquisitions(
        @Query("lt") String timestamp
    );

    @GET("prices/downsync")
    public Call<List<PrixDeVente>> syncMissedPrices(
        @Query("lt") String timestamp
    );
    ...
    public Call<List<LigneVente>> syncMissedSaleItems(
        @Query("lt") String timestamp
    );

    @GET("traisorerie/downsync")
    public Call<List<Traisorerie>> syncMissedTransactions(
        @Query("lt") String timestamp
    );

    @GET("tresor/downsync")
    public Call<List<CompteTresor>> syncMissedAccounts(
        @Query("lt") String timestamp
    );
    ...
    public Call<List<Operation>> syncMissedOperations(
        @Query("lt") String timestamp
    );

    @GET("expenses/downsync")
    public Call<List<Depense>> syncMissedDepenses(
        @Query("lt") String timestamp
    );

    @GET("matieres-industrial/downsync")
    public Call<List<Matiere>> syncMissedMatieres(
        @Query("lt") String timestamp
    );

    @GET("matieres-sku/downsync")
    public Call<List<MatiereSku>> syncMissedMatiereSkus(
        @Query("lt") String timestamp
    );
    ...
    public Call<List<Entreposer>> syncMissedEntreposages(
        @Query("lt") String timestamp
    );

    @GET("production/downsync")
    public Call<List<Production>> syncMissedProductions(
        @Query("lt") String timestamp
    );

    @GET("repartitions/downsync")
    public Call<List<Repartir>> syncMissedRepartirs(
        @Query("lt") String timestamp
    );

    @GET("imputers/downsync")
    public Call<List<Imputer>> syncMissedImputers(
        @Query("lt") String timestamp
    );

    @GET("expeditions/downsync")
    public Call<List<Expedition>> syncMissedExpeditions(
        @Query("lt") String timestamp
    );

    @GET("commandes/downsync")
    public Call<List<Commande>> syncMissedCommandes(
        @Query("lt") String timestamp
    );

    @GET("list-commandes/downsync")
    public Call<List<CommandeLister>> syncMissedCommandListers(
        @Query("lt") String timestamp
    );

    @GET("sync/validation/hash")
    Call<ValidationHashResponse> getValidationHash(
        @Query("enterpriseId") String enterpriseId,
        @Query("regionId") String regionId
    );

    @POST("sync/adaptive/upsync")
    Call<BatchResultDto> adaptiveUpsync(@Body List<BatchMutationDto> mutations);
